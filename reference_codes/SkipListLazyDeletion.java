 ...
 */
public class SkipListLazyDeletion implements SetADT {
    ...
    public boolean remove(int key) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (iMarkedIt) {
                    // Node has been marked. Lazy: do NOT call find() here.
                    return true;
                } else if (marked[0])
                    return false;
            }
    ...
    public boolean contains(int key) {
        ...
        // At level 0, curr is the first node such that curr.key >= key and curr is not marked.
        return curr.key == key;
    }
