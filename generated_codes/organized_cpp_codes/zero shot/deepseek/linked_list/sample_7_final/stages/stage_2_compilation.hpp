    ...
    bool add(int key) override {
        while (true) {
            ...
            while (true) {
                ...
                Node* succ = unmarked_curr ? unmarked_curr->next.load(std::memory_order_acquire) : nullptr;
                
                while (unmarked_curr && is_marked_ref(succ)) {
                    ...
                    succ = unmarked_curr ? unmarked_curr->next.load(std::memory_order_acquire) : nullptr;
                }
