...
public class ConcurrentDataStructure implements SetADT {
    ...
    private static class Node {
        ...
        Node(int key, int height) {
            ...
            this.next = (AtomicMarkableReference<Node>[]) new AtomicMarkableReference[MAX_LEVEL];
    ...
    public ConcurrentDataStructure() {
        ...
        Node tail = new Node(Integer.MAX_VALUE, MAX_LEVEL - 1);
    ...
    private int randomLevel() {
        int level = 0;
        while (ThreadLocalRandom.current().nextBoolean() && level < MAX_LEVEL - 1) {
            level++;
        }
        return level;
    }
